...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> 
	<title>detail</title>
<link rel="stylesheet" type="text/css" href="loanDetail/css/style.css">
<!-- <link rel="stylesheet/less" type="text/css" href="css/style.less" /> -->
<script type="text/javascript" src="js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="loanDetail/js/all.js"></script>
<!--[if IE 6]> 
	  ...
	  <div class="zxcf_detail px1000">
	  	     <div class="detail_intro clearfix">
	  	     	    <div class="detail_intro_l fl">
	  	     	    	  <div class="detail_introl_tit clearfix">
	  	     	    	  	  <div class="det_introl_tit_l fl">
	  	     	    	  	  	   <span>${loan.loanType }</span> 购车借款23万第2标13万
	  	     	    	  	  </div>
	  	     	    	  	  <!-- end l -->
	  	     	    	  	  <div class="det_introl_tit_r fr">
	  	     	    	  	  	  保障级别：A级 <img src="loanDetail/images/det_wenhao.png" alt="">
	  	     	    	  	  </div>
	  	     	    	  </div>
	  	     	    	  <!-- end tit -->
	  	     	    	  	    ...
	  	     	    	  	    <ul class="det_intro_tul clearfix">
	  	     	    	  	    	<li>
	  	     	    	  	    		 ...
	  	     	    	  	    		 <span style="color:#ff7112;">
	  	     	    	  	    		 	 <strong>${(loan.inter)*100 }</strong>% 年化
	  	     	    	  	    		 </span>
	  	     	    	  	    	</li>
	  	     	    	  	    	<li>
	  	     	    	  	    		 项目期限<br>
	  	     	    	  	    		 <span>
	  	     	    	  	    		 	 <strong>${loan.deadLine }</strong>个月
	  	     	    	  	    		 </span>
	  	     	    	  	    	</li>
                                    <li>
	  	     	    	  	    		 项目规模<br>
	  	     	    	  	    		 <span >
	  	     	    	  	    		 	 <strong>${loan.loanMoney }</strong>万
	  	     	    	  	    		 </span>
	  	     	    	  	    	</li>
	  	     	    ...
	  	     	    <div class="detail_intro_r fr">
                          ...
                          <!--  -->
                          <p class="det_rzye clearfix"><span class="fl">融资余额</span><em class="fr"><strong>${loan.curMoney }</strong>元</em></p>
                          <p class="det_input">
	  	     	   	      ...
	  	     	   	      <div class="det_con_proone clearfix">
	  	     	   	           <div class="det_l_box fl">
	  	     	   	            ...
	  	     	   	            <div class="det_proone_l">
	  	     	   	            	   ...
	  	     	   	            	   <div class="det_clsj ">
	  	     	   	            	     <img src="loanDetail/images/det_pic01.png" alt="">
	  	     	   	            	   </div>
	  	     	   	            	    <div class="det_clsj ">
	  	     	   	            	     <img src="loanDetail/images/det_pic02.png" alt="">
	  	     	   	            	   </div>
                                   ...
                                   <!--  -->
                                     ...
                                     <!-- end 抵押物信息 -->
	  	     	   	            ...
	  	     	   	            <div class="det_proone_l" style="display:none;">
	  	     	   	            	 ...
	  	     	   	            	 <p class="dhgl_p1"><img src="loanDetail/images/1.jpg" alt="">融资成功,企业正在还款</p>
	  	     	   	            	 <h2 class="det_proone_tit">还款概况</h2>
	  	     	   	            	 <ul  class="dhgl_ul">
	  	     	   	            	 	 <li>
	  	     	   	            	 	    <img src="loanDetail/images/2.jpg" alt="">
	  	     	   	            	 	    <span>应付利息</span>
	  	     	   	            	 	    <span>123213.4元（12期）</span>
	  	     	   	            	 	 </li>
	  	     	   	            	 	 <li>
	  	     	   	            	 	    &nbsp;<img src="loanDetail/images/3.jpg" alt="">
	  	     	   	            	 	    <span>应付利息</span>
	  	     	   	            	 	    <span>123213.4元（12期）</span>
	  	     	   	            	 	 </li>
	  	     	   	            	 	 <li>
	  	     	   	            	 	    &nbsp;<img src="loanDetail/images/4.jpg" alt="">
	  	     	   	            	 	    <span>应付利息</span>
	  	     	   	            	 	    <span>123213.4元（12期）</span>
	  	     	   	            	 	 </li>
	  	     	   	            	 	 <li>
	  	     	   	            	 	    <img src="loanDetail/images/5.jpg" alt="">
	  	     	   	            	 	    <span>应付利息</span>
	  	     	   	            	 	    <span>123213.4元（${loan.deadLine }期）</span>
	  	     	   	            	 	 </li>
                                     ...
                                     <div class="pl20 pr20 pt20">
	  	     	   	            ...
	  	     	   	            <div class="det_proone_l" style="display:none;">
	  	     	   	            	  <P class="det_tbjl_tit">
	  	     	   	            	     <span class="mr30"><img src="loanDetail/images/det_tbjl_pic01.png" alt=""> 
	  	     	   	            	     目前总金额：￥${loan.curMoney }</span>
	  	     	   	            	     <span><img src="loanDetail/images/det_tbjl_pic02.png" alt=""> 
	  	     	   	            	     剩余金额：￥${ loan.loanMoney-loan.curMoney}</span>
	  	     	   	            	  </P>
	  	     	   	            	  <table class="det_table">
	  	     	   	            	  	  ...
	  	     	   	            	  	  <c:forEach items="${iUsers!=null }" var="u">
	  	     	   	            ...
	  	     	   	            <!-- end l -->
	  	     	   	      	    ...
	  	     	   	      	    <div class="det_proone_r fl">
	  	     	   	      	    	   ...
	  	     	   	      	    	   <ul class="det_proone_rul">
	  	     	   	      	    	   	   <li class="clearfix">
	  	     	   	      	    	   	   	  <span class="fl mr15">
	  	     	   	      	    	   	   	  	  <img src="loanDetail/images/det_dbh01.png" alt=""><br><br>
	  	     	   	      	    	   	   	  	  担保函
	  	     	   	      	    	   	   	  	  
	  	     	   	      	    	   	   	  </span>
	  	     	   	      	    	   	   	   <span class="fl">
	  	     	   	      	    	   	   	  	  <img src="loanDetail/images/det_dbh02.png" alt=""><br><br>
	  	     	   	      	    	   	   	  	  身份证
	  	     ...
	  	     <div class="det_comment mt30">
	  	     	   ...
	  	     	   <div class="det_comment_text clearfix">
	  	     	   	   <div class="comment_l fl pl30">
	  	     	   	   	   <img src="loanDetail/images/comment_pic02.png" alt="">
	  	     	   	   </div>
	  	     	   	   <!-- end l -->
	  	     	   ...
	  	     	   <div class="comment_show">
	  	     	   	     <ul class="comment_show_ul">
	  	     	   	     	 <li class="clearfix">
	  	     	   	     	 <span class="fl mr30">
	  	     	   	     	   <img src="loanDetail/images/comment_pic03.png" alt="">	
	  	     	   	     	 </span>
	  	     	   	     	 <div class="fl ml">
	  	     	   	     	 	  <h3>发布的风向 标</h3>
	  	     	   	     	 	  <p><img src="loanDetail/images/comment_pic04.png" alt=""></p>
	  	     	   	     	 	  <p>前天 13:40</p>
	  	     	   	     	 </div>
	  	     	   	     	 </li>
	  	     	   	     	 <li class="clearfix">
	  ...
	  <div class="zscf_aboutus px1000 clearfix">
	  	    <div class="zscf_aboutus_l fl">
	  	    	   <ul class="zscf_aboutus_lul clearfix">
	  	    	   	  <li class="pt10"><a href="#"><img src="loanDetail/images/app.png" alt=""></a>
	  	    	   	  </li>
	  	    	   	  <li>
	  	    	   	  <p class="pb20">服务热线</p>
	  	    	   	  ...
	  	    	   	  <li>
	  	    	   	  	  <p class="pb10 linkpic">
	  	    	   	  	     <a href="#"><img src="loanDetail/images/ft_sina.png" alt=""></a>
	  	    	   	  	     <a href="#"><img src="loanDetail/images/ft_weixin.png" alt=""></a>
	  	    	   	  	     <a href="#"><img src="loanDetail/images/ft_erji.png" alt=""></a>
	  	    	   	  	  </p>
	  	    ...
	  	    <div class="zscf_aboutus_r fl clearfix">
	  	    	 <a href="#" class="fl ft_ewm"><img src="loanDetail/images/ft_erweima.png" alt=""></a>
...
<div class="zscf_bottom_wper">
	<div class="zscf_bottom px1000 clearfix">
		  ...
		  <p class="fr">
		    <a href="#"><img src="loanDetail/images/360.png" alt=""></a>
		    <a href="#"><img src="loanDetail/images/kexin.png" alt=""></a>
		    <a href="#"><img src="loanDetail/images/norton.png" alt=""></a>
		  </p>
	</div>
</div>
<!-- footer end -->
